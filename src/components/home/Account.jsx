...
export const Account = () => {
  return (
    <section className="bg-white-500 xsm:px-[1.25rem] sm:px-[2.8125rem] md:px-[3.75rem] lg:px-[6.25rem] xl:px-[9.375rem] py-[6.25rem] lg:py-36">
      <div className="w-full max-w-[725px]">
        <h2 className="leading-[1.15] font-Duplicate-Sans  xsm:text-[1.875rem] sm:text-[2rem] md:text-5xl lg:text-[3.5rem] xl:text-[4rem] md:tracking-[-2.5px] font-semibold">
      ...
      <div>
        <div className="mt-[3.75rem] lg:mt-20 grid gap-5 grid-cols-1 sm:grid-cols-2">
          <div className="bg-white-100 rounded-[0.9375rem] xsm:p-6 sm:p-10 lg:p-[2.8125rem] xl:p-[3.75rem]">
            <h4 className="text-center lg:text-left xsm:text-[1.5rem] sm:text-3xl lg:text-4xl font-semibold font-Duplicate-Sans tracking-[-2px]">
              Accounts
            </h4>
