...
export const Features = () => {
  return (
    <div className="bg-white-500 xsm:px-[1.25rem] sm:px-[2.8125rem] md:px-[3.75rem] lg:px-[6.25rem] xl:px-[9.375rem] xsm:py-[5rem] sm:py-[6.25rem] lg:py-36">
      <div className="xsm:mb-[2.5rem] sm:mb-[3.75rem] lg:mb-20">
        <h2 className="font-Duplicate-Sans leading-[1.15]  xsm:text-[1.875rem] sm:text-4xl lg:text-[3.5rem] xl:text-[4rem]">
          Features
        </h2>
      </div>
      ...
      <div className="flex flex-col md:flex-row items-start justify-between space-y-10 md:space-y-0 md:space-x-8">
        <div className="max-w-[500px] md:max-w-[189px] lg:max-w-[280px]">
          <div className="xsm:h-8 xsm:w-8 sm:h-10 sm:w-10 lg:h-12 w-12 mb-5">
            <img src={Customizable} alt="" className="w-full" />
          </div>
          <div>
            <h5 className="leading-[1.25] font-Duplicate-Sans  xsm:text-[1.25rem] sm:text-[1.5rem] lg:text-[2rem] mb-4 md:mb-5">
              Customizable
            </h5>
        ...
        <div className="max-w-[500px] md:max-w-[189px] lg:max-w-[280px]">
          ...
          <div>
            <h5 className="leading-[1.25] font-Duplicate-Sans  xsm:text-[1.25rem] sm:text-[1.5rem] lg:text-[2rem] mb-4">
              Secure
            </h5>
