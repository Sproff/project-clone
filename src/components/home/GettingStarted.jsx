...
export const GettingStarted = () => {
  return (
    <section
      className="xsm:px-[1.25rem] sm:px-[2.8125rem] xsm:py-[6.25rem] sm:py-[7.5rem] md:px-[3.75rem] lg:px-[6.25rem] xl:px-[9.375rem]"
      style={{ backgroundImage: `url(${GettingStartedBg})` }}
    >
      <div>
        <h2 className="text-white-100 font-Duplicate-Sans  xsm:text-[1.875rem] sm:text-4xl md:text-5xl lg:text-[3.5rem] xl:text-[4rem] leading-[1.15]">
          Getting started
        </h2>
      </div>
      ...
      <div className="flex flex-col gap-[20px]">
        <div className="bg-white-100 mt-[3.75rem] lg:mt-20 rounded-[0.9375rem] xsm:px-6 sm:px-10 lg:px-[3.75rem] pt-[3.75rem] lg:pt-20 flex flex-col lg:flex-row gap-[2.5rem]">
          <div className="pb-6 lg:pb-24 flex flex-col items-center lg:items-start">
            ...
            <h2 className="xsm:text-[1.875rem] sm:text-[2.1rem] md:text-[2rem] lg:text-[3rem] xl:text-[3.5rem] font-Duplicate-Sans  leading-tight mb-[2.1875rem] text-center lg:text-left">
        ...
        <div className="flex flex-col xl:flex-row gap-[20px]">
          <div>
            <div className="xsm:p-6 sm:p-10 lg:p-[2.8125rem] xl:p-[3.75rem] bg-white-100 flex flex-col items-center lg:items-start rounded-[0.9375rem]">
              ...
              <h4 className="leading-[1.25] mb-[2.1875rem] xsm:text-[1.5rem] sm:text-[1.875rem] lg:text-4xl  font-Duplicate-Sans text-center lg:text-left">
                Plug-and-play SDKs
              </h4>
              <a
                href="##"
                target="_blank"
                rel="noreferrer"
                className="xsm:text-[.9375rem] sm:text-base lg:text-lg font-bold flex items-center text-blue-100"
              >
                Explore SDKs{" "}
                <svg viewBox="0 0 25 25" fill="none" className="xsm:w-5 lg:w-6">
                  <path
