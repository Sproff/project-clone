    ...
    <section className="bg-white-500 xsm:px-[1.25rem] sm:px-[2.8125rem] md:px-[3.75rem] lg:px-[6.25rem] xl:px-[9.375rem] py-[6.25rem] lg:py-36">
      <div className="">
        <div className="max-w-3xl w-full">
          <h2 className="font-Duplicate-Sans leading-[1.15] xsm:text-[1.875rem] sm:text-4xl md:text-5xl lg:text-[3.5rem] xl:text-[4rem] font-semibold tracking-[-2px] md:tracking-[-3.3px]">
